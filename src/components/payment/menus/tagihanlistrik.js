...
import logo from '../../../images/buttonImage/tagihan_listrik.svg'
...
class Tagihanlistrik extends Component {
    constructor(){
      super()
      this.state={
        cekTagihan :'',
      ...
      axios.post(API+PASCABAYAR_CEK, body, {headers:header})
        .then(res => {
          ...
          if(order.errNumber !== '0'){
            ...
            document.getElementById('form_detail_listrik').scrollIntoView({behavior:'smooth'})
          }
          // console.log(order)
        })
        .catch(error => {
    ...
    render() {
      // console.log('order',this.state.resTagihan)
      ...
      const {resTagihan} = this.state
        ...
        return (
            <div>
                <div className=' border shadow p-3 mt-3 mb-3 new-radius' id="form_detail_listrik">
                    <div className="row mt-2">
                        <div className='col-sm-12'>
                            <h3 style={{color:'#2E7D32',marginTop:'10px',marginBottom:'10px'}} >Tagihan Listrik</h3>
                        </div>
                    </div>
                    <div className='row'>
                ...
                <div className='border shadow p-3 mt-3 mb-3 new-radius'>
                    ...
                    <div className='row mt-3 ml-0'>
                        <button data-toggle="modal" data-target="#tagihanListrik" className='bt-green'>PROSES</button>
                    </div>
                </div>
                } 

                {/* <!-- Modal --> */}
                <div className="modal fade" id="tagihanListrik" data-backdrop="static" tabIndex="-1" role="dialog" aria-labelledby="tagihanListrikLabel" aria-hidden="true">
...
export default connect(mapStateToProps, mapDispatchToProps)(Tagihanlistrik)
