...
import logo from '../../../images/buttonImage/pgn.svg'
...
class pgn extends Component {
      ...
      axios.post(API+PASCABAYAR_CEK, body, {headers:header})
        .then(res => {
          ...
          if(order.errNumber !== '0'){
            ...
            document.getElementById('form_detail_pgn').scrollIntoView({behavior:'smooth'})
          }
          // console.log(order)
        })
        .catch(error => {
    ...
    render() {
      if(this.state.redirect === true){
        ...
        return (
            <div>
                <div className=' border shadow p-3 mt-3 mb-3 new-radius' id="form_detail_pgn">
                    <div className="row mt-2">
                        <div className='col-sm-12'>
                            <h3 style={{color:'#2E7D32',marginTop:'10px',marginBottom:'10px'}} >PGN</h3>
                        </div>
                    </div>
                    <div className='row'>
                ...
                <div className='border shadow p-3 mt-3 mb-3 new-radius'>
                    ...
                    <div className='row mt-3 ml-0'>
                        <button data-toggle="modal" data-target="#pgn"  className='bt-green'>PROSES</button>
                    </div>
                </div>
                } 

                 {/* <!-- Modal --> */}
                 <div className="modal fade" id="pgn" data-backdrop="static" tabIndex="-1" role="dialog" aria-labelledby="pgnLabel" aria-hidden="true">
...
export default connect(mapStateToProps, mapDispatchToProps)(pgn)
