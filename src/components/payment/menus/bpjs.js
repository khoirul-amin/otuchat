...
import logo from '../../../images/buttonImage/bpjs.svg'
...
class bpjs extends Component {
        ...
        axios.post(API+PASCABAYAR_CEK, body, {headers:header})
          .then(res => {
            ...
            if(order.errNumber !== '0'){
              ...
              document.getElementById('form_detail_bpjs').scrollIntoView({behavior:'smooth'})
            }
            // console.log(order)
          })
          .catch(error => {
    ...
    render() {
      if(this.state.redirect === true){
        ...
        return (
            <div>
                <div className=' border shadow p-3 mt-3 mb-3 new-radius' id="form_detail_bpjs">
                    <div className="row mt-2">
                        <div className='col-sm-12'>
                            <h3 style={{color:'#2E7D32',marginTop:'10px',marginBottom:'10px'}} >BPJS</h3>
                        </div>
                    </div>
                    <div className='row'>
                ...
                <div className='border shadow p-3 mt-3 mb-3 new-radius'>
                    ...
                    <div className='row mt-3 ml-0'>
                        <button  data-toggle="modal" data-target="#bpjs" className='bt-green'>PROSES</button>
                    </div>
                </div>
                } 

                 {/* <!-- Modal --> */}
                 <div className="modal fade" id="bpjs" data-backdrop="static" tabIndex="-1" role="dialog" aria-labelledby="bpjsLabel" aria-hidden="true">
                                    ...
                                    <table className="w-100">
                                        <tbody>
                                            ...
                                            <tr style={{fontWeight:'bold', color:'#388E3C'}}>
                                                <td className="pt-2 pb-4 w-25">Poin</td>
                                                <td className="pt-2 pb-4">:</td>
                                                <td className="pt-2 pb-4" align="right">{resTagihan.ep} Poin</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
