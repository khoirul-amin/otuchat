...
import logo from '../../../images/buttonImage/pasca_bayar.svg'
...
class pascabayar extends Component {
    constructor(){
        super()
        this.state={
            cekTagihan: '',
        ...
        axios.post(API+PASCABAYAR_CEK, body, {headers:header})
          .then(res => {
            ...
            if(order.errNumber !== '0'){
              ...
              document.getElementById('form_detail_pasca').scrollIntoView({behavior:'smooth'})
            }
            // console.log(order)
          })
          .catch(error => {
    ...
    render() {
      if(this.state.redirect === true){
        ...
        // console.log(resTagihan)
      return (
          <div>
              <div className=' border shadow p-3 mt-3 mb-3 new-radius' id="form_detail_pasca">
                  <div className="row mt-2">
                      <div className='col-sm-12'>
                          <h3 style={{color:'#2E7D32',marginTop:'10px',marginBottom:'10px'}} >Pasca Bayar</h3>
                      </div>
                  </div>
                  <div className='row'>
                  ...
                  <div className='row mt-2'>
                      <div className='col-sm mt-2'>
                          ...
                          :
                              ...
                              // <button onClick={this.handleSubmit} style={style.btGreen} className='btn mt-4 rounded-0'>Cek Tagihan</button>
                          }
                      </div>
                  </div>
              </div>
              ...
              <div className='border shadow p-3 mt-3 mb-3 new-radius'>
                  ...
                  <div className='row mt-3 ml-0'>
                      <div align="center" data-toggle="modal" data-target="#pascabayar" className='bt-green'>PROSES</div>
                  </div>
              </div>
              } 

               {/* <!-- Modal --> */}
               <div className="modal fade" id="pascabayar" data-backdrop="static" tabIndex="-1" role="dialog" aria-labelledby="pascabayarLabel" aria-hidden="true">
...
export default connect(mapStateToProps, mapDispatchToProps)(pascabayar)
const style = {
    btGreen:{
        fontSize:'14px',
        color:'#FFFFFF',
